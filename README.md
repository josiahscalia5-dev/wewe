...
- The patrol robot walks the mid-ground, turns, scans, and hunts you when it sees you exposed
  inside its facing cone for 0.6 s: ALERT → CHASE → (you hide) SEARCH → PATROL. If it catches
  you: stunned 1.5 s, −5 s on the timer, knockback, then a 3 s grace period.
